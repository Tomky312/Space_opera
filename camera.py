    ...
    def draw_objects(self, batch):
        ...
        for ship in self.game.current_field.ships:
            ...
            if ship.selected:
                ...
                if ship.maneuver_type == "none" and my_math.distance(ship.world_pos, ship.world_dest) > 10 or True: # temporary true
        ...
        for asteroid_cluster in self.game.current_field.asteroid_clusters:
            for asteroid in asteroid_cluster.asteroids:
